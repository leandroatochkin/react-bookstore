...
const handleModalClose = () => {
  ...
  return (
    <div className={style.container}>
        {openModal && <SimpleMessage message={'User created succesfully!'} setFunction={setOpenModal} extraFunction={handleModalClose}/>}
        ...
        <h1 className={style.title}>New Account</h1>
            ...
            <p>Sint magna ipsum ullamco tempor ipsum nostrud cillum reprehenderit id nisi non in eu. Mollit elit incididunt aliquip aliquip aliqua consectetur anim sit duis. Consequat aliquip ad minim fugiat veniam ea et. Velit culpa cillum in commodo cillum id consectetur proident minim ut.

Laboris ipsum ipsum officia minim incididunt nostrud non nostrud commodo sint esse. Nulla officia laborum deserunt quis in Lorem cillum qui aliquip aute adipisicing. Nisi ipsum eu ad quis irure adipisicing id excepteur ullamco officia. Velit pariatur aliquip amet fugiat laborum ipsum sint ut consequat officia in dolor. Consectetur sit laboris minim pariatur amet aute est. Esse aliqua Lorem dolore ut sint qui nisi nulla est.

Magna non occaecat velit quis labore ex dolor consectetur duis tempor sunt reprehenderit enim. Sunt duis occaecat quis et tempor occaecat irure do nostrud. Labore voluptate anim ut cupidatat reprehenderit sit cillum anim do veniam nostrud commodo irure aute. Pariatur sit anim magna incididunt proident exercitation labore fugiat do id mollit. Esse do exercitation nostrud nisi velit est quis mollit aliqua aute Lorem dolore. Ea veniam duis dolor occaecat. Elit nostrud officia minim nostrud veniam occaecat cupidatat aliqua deserunt cillum tempor.</p>
